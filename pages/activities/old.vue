                      ...
                      <div class="tab-pane fade " :class="{'active show': status_tap === 1? true : false }" id="" >
                        ...
                        <div class="event-style1 w-100">
                          ...
                          <div class="event-info">
                            ...
                            <!-- start -->
                            <!-- <div class="row">
                              <div class="col-6"><p class="mb-0">-Project Management Officer</p></div>
                              <div class="col-6"><p class="mb-0">-Project Manager</p></div>
                              <div class="col-6"><p class="mb-0">- IT Operation</p></div>
                              <div class="col-6"><p class="mb-0">- UX/UI Designer</p></div>
                              <div class="col-6"></div>
                            </div> -->
                            <!-- End -->
